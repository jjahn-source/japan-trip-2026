...
export const FOOD: CityFood[] = [
  {
    ...
    items: [
      ...
      { dish: "Konbini hall of fame run", jp: "コンビニ飯", where: "7-Eleven egg sando, Lawson karaage-kun, FamilyMart Famichiki — every corner, 24h", why: "The real Japanese breakfast/midnight ritual: $1.50 (¥240) egg sando on cloud bread, hot fried chicken at the register, Strong Zero for the walk home. The franchise that never closes and never disappoints", groupTip: "Send one man on a konbini supply run for 8 — egg sandos, Famichiki, Pocari, and Ukon turmeric shots BEFORE the drinking. The Famichiki + plain-bun forbidden burger is off-menu but legal" },
      { dish: "Hot-case oden & nikuman", jp: "おでん・肉まん", where: "Any konbini register counter, Nov–Feb only", why: "December unlocks the konbini hot case: simmered daikon, eggs and chikuwa in dashi for ~$0.60 (¥100) a piece, plus fist-sized steamed pork buns you cradle like a hand-warmer on a freezing illumination walk", groupTip: "Point at the case, they ladle oden into a cup; grab a nikuman each for the walk. The pizza-man variant is the chaos pick — somebody has to take one for the crew" },
    ],
  },
  {
    city: "Kyoto",
  ...
  },
  {
    ...
    items: [
      ...
      { dish: "Ikayaki & Dotonbori street crawl", jp: "いか焼き", where: "Dotonbori stalls, Sennichimae, Hanshin depachika (the legendary ikayaki counter)", why: "Osaka's other street weapons: ikayaki (squid pressed flat into a savory crepe-pancake, $2 / ¥300), korokke, butaman, and a riverside neon backdrop. Eat-while-you-walk is the whole sport here — Osaka doesn't do polite", groupTip: "Graze a stall every 50 meters; one cheap thing per stop keeps 8 guys moving. Hanshin's ikayaki is the cult pick — locals queue for it, so should you" },
      { dish: "Kintsuba, kasutera & depachika snack raid", jp: "デパ地下スナック", where: "Daimaru / Hanshin / Takashimaya basements, Namba", why: "The savory-and-sweet konbini upgrade: warm kintsuba (pan-griddled red-bean cakes), castella sponge, freshly fried croquettes and discounted bento after 19:00. A degenerate's grazing buffet at depachika prices", groupTip: "Hit it after 19:00 for half-price wagyu boxes and croquettes; split a castella loaf for the Airbnb. ~$2–6 (¥300–1k) a haul" },
    ],
  },
  {
    city: "Nara",
