...
export const BUDGET_ITEMS: BudgetItem[] = [
  ...
  { id: "onsen", label: "Onsen & sento days", perPersonUSD: 35, note: "Hakone Yuryo day-pass + Funaoka electric bath + Thermae-Yu", emoji: "♨️" },
  { id: "trains", label: "Trains & transit", perPersonUSD: 520, note: "All shinkansen blocks + Hakone Freepass + Kintetsu + metro (~¥78,000) — the 5-day-trip route rides a LOT of rail", emoji: "🚄" },
